 ...
 */
public class DriveToPosOneEncoderTimeOutCommand implements AutonCommand {
    ...
    public DriveToPosOneEncoderTimeOutCommand(double distance, double angle, double timeOutSecs) {
    ...
    public boolean run() {
       ...
       // prevRightDist = currRightDist;
        ...
        double rightPIDOutput = MathLogic.limitAbs(rightDrivePID.calcPID(distGoal, currLeftDist), 1);
